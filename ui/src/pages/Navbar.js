    ...
    <nav className="border-b-2 border-gray-200 py-2.5 px-[200px] bg-purple-50">
      <div className="container flex items-center justify-between">
        ...
        <div className="flex space-x-8">
          <Link to='/' className="text-xl font-bold text-gray-900 hover:bg-green-300 px-3 py-2 rounded-lg cursor-pointer">Home</Link>
          <Link className="text-xl font-bold text-gray-900 hover:bg-green-300 px-3 py-2 rounded-lg">Resources</Link>
